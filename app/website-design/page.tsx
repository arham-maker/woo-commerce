...
export const metadata: Metadata = {
  ...
  description:
    "Level up your online presence with WooCommerce Launchpad's custom web design services.",
};
    ...
    <>
      ...
      <main className="flex-1">
        <ServicePageHero
          ...
          description="Level up your online presence with WooCommerce Launchpad's custom web design services. Our team of web professionals will conjure up a visually captivating and user-friendly website masterpiece that'll leave your competitors spellbound."

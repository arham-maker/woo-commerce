    ...
    <section className="relative overflow-hidden bg-hero-bg">
      <div className="relative mx-auto grid max-w-[1320px] items-center gap-10 px-4 pt-[60px] pb-10 sm:px-6 md:px-8 lg:grid-cols-2 lg:gap-12 lg:px-10 lg:pb-0 xl:pl-16 xl:pr-10">
        <div className="space-y-6 pb-6 lg:pb-16">
          <h1
            className={cn(
              "max-w-xl text-[32px] font-medium leading-[1.15] tracking-tight text-black transition-transform duration-700 sm:text-[44px] lg:text-[60px]",
              ready ? "translate-x-0" : "-translate-x-8",
            )}
          >
            <span className="font-bold">
              Please take a look at our elaborate portfolio
            </span>
          </h1>
          ...
          >
            You&apos;ll get an idea of the excellence we provide to our clients
          </p>
        ...
        >
          <Image
            src={ASSETS.portfolioHero}
            alt="Website portfolio showcase across devices"
            width={1003}
            height={510}

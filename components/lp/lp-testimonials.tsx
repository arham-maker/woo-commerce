...
const testimonials = [
  {
    ...
    body: "“Partnering with WooCommerce Launchpad has transformed our e-commerce business. Our custom-designed WooCommerce site is not only visually stunning but has also boosted our sales by 50% in just three months. The team's expertise and dedication are unmatched.”",
  ...
  },
  {
    ...
    body: "“Thanks to WooCommerce Launchpad, our online store now runs smoothly and looks fantastic. The new site is optimized for performance, and our sales have increased by 40% since the launch. Their ongoing support has been invaluable.”",
  ...
  },
  {
    ...
    body: "“WooCommerce Launchpad exceeded our expectations. Our sales have soared by 60% since they redesigned our site. The team provided exceptional support and customized solutions that perfectly fit our needs. Highly recommended!”",
  ...
  },
  {
    ...
    body: "“As a startup, we needed a reliable partner to help us make our mark. WooCommerce Launchpad delivered beyond our dreams, with a site that’s brought in a 70% increase in sales. Their expertise in WooCommerce is truly impressive.”",
  ...
  },
  {
    ...
    body: "“Our sales have never been better, thanks to WooCommerce Launchpad. The revamped site is fast, user-friendly, and visually appealing, leading to a 55% sales increase. Their team is professional, responsive, and a pleasure to work with.”",
  ...
  },
  {
    ...
    body: "“Working with WooCommerce Launchpad was the best decision we made for our e-commerce business. Our sales jumped by 45% after the redesign. The site's performance is top-notch, and their ongoing support keeps us ahead of the competition.\"",

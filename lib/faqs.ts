export const FAQS = [
  ...
  {
    q: "How long does it take to develop a custom WooCommerce store?",
    a: "The timeline for developing a custom WooCommerce store depends on the complexity and specific requirements of your project. Typically, a basic store can be completed within a few weeks, while more complex projects may take a few months. We provide detailed timelines and updates throughout the development process.",
  },
  {
    q: "Can you help with migrating my existing e-commerce store to WooCommerce?",
    a: "Yes, we offer comprehensive migration services to transition your existing store to WooCommerce. Our team ensures a smooth and seamless migration, preserving your data and minimizing downtime.",
  },
  {
    q: "How do you ensure the quality and performance of the WooCommerce sites you develop?",
    a: "We prioritize quality and performance through rigorous quality control processes, performance testing, and adherence to best practices in web development. Our sites are also optimized for SEO and high performance to enhance user experience and drive results.",
  },
  {
    q: "What kind of support and maintenance do you offer after the site is live?",
  ...
  {
    q: "Are your WooCommerce development services SEO-friendly?",
    a: "Yes, all our WooCommerce development services include SEO-friendly practices to help improve your site's visibility in search engines. We focus on optimizing site structure, meta tags, and content to enhance your search engine rankings.",
  },
  {
    q: "Can you integrate WooCommerce with other systems or platforms?",

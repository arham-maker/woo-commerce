import type { LegalBlock, LegalSection } from "@/lib/privacy-content";
...
export const TERMS_SECTIONS: TermsSection[] = [
  {
    ...
    blocks: [
      {
        type: "p",
        html: "The allotted number of revisions is based on your selected package and you can demand as much revisions as stated in your package details. We focus on providing the best services to our customers and will continue revising until your needs is met. You are not liable to pay additional price if the design concepts are not changed. You will have your revised design in 48 hours.",
      },
      {
        type: "p",
        html: "Any changes/revisions requested after the logo designs are finalized will be treated as a new order and charged separately.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        html: "To claim your refund in accordance with our refund policy, follow the following steps: <br />You can claim your refund by:",
      },
      {
        type: "ul",
        items: [
          'Dialing our Toll Free Number # <a href="tel:+18442135457" class="text-brand underline hover:opacity-80">+1 844 213 5457</a>',
          'Live Chat. <a href="#" class="cursor-pointer text-brand underline hover:opacity-80">Click here to start chat now</a>',
          'Sending us an <a href="mailto:info@woocommerceweb.com" class="text-brand underline hover:opacity-80">Email</a>.',
        ],
      },
      {
        type: "p",
        html: "As soon as we receive your refund request, we will respond to it at our earliest, once the required analysis is completed, we will initiate the process.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        html: "We do our best to meet your requirements and our designers do their best to fulfill your expectations.",
      },
      {
        type: "p",
        html: "We believe in providing best designs and each of our designs is well researched and well crafted.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        html: "Our customer support is present 24/7 to answer all of your concerns and queries, our team will answer your concerns anytime and every time.",
      },
    ],
  },
  {
